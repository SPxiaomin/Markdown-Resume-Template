...
* 鹰角&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&emsp;2024.4~至今&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 平台部门
* 莉莉丝&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;2021.3~2024.1&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; 中台产品部门
...
* 对分布式、高并发等略有经验，对于Golang/Redis/Kafka/RocketMQ等技术栈有实际项目经验.
...
3. 礼包平台 / 兑换码 - 2025.1-至今
   * 背景&目标
     * CDKEY兑换码作为礼包的一种发放形式.
   * 项目挑战
     * 兑换码兑换核销部分完全采用纯DB，DB单表上限基本在3w左右.
     * 因为采用 `按年 + 20分片` 的方案，用户ID会HASH到任意一张表中，提升整体的服务兑换性能.
     * 发奖部分采用Kafka投递 + Redis zset「issuePrizePending」缓存兑换码记录用于重投.

4. 其他
   * 游戏包体资源上传平台 / 游戏活动服务侧开发 / 官网系统维护等.
   * 框架等基建的基础维护.

### 莉莉丝

1. PSP「莉莉丝客服系统,从0-1」- 2021.3-2024.1
   * 背景&目标
...
3. Gear服务中台「Nodejs全栈」2023.3-2024.1
    * 背景&目标
...
4. FAU静态资源服务「Golang&go-zero」2023.3-2024.1
   * 背景&目标
...
5. Lilith公司私有源站「开发&维护, Nodejs&Golang」2021.3-2024.1
   * 背景&目标
     * 公司内部共有组件的私有化诉求.
     * 团队内部跨项目的代码共享.
   * 角色&责任
